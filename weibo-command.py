...
def update_token():
    ...
    #获得code
    code = 'd624fa7b15d139c453023f4b70731e79' #需要获得一个新的code
...
def main():
    ...
    #access_token = r.access_token # 新浪返回的token，类似abc123xyz456
    #如果过期了，需要将上面的几步再执行一次获得新的access_token，并手动替换
    access_token = '2.00F9dUnB0kKJTs9164339a26ROiY8B' #需要被更新
    expires_in=1614153145 #需要被更新
    client.set_access_token(access_token,expires_in) #保存这两个值
